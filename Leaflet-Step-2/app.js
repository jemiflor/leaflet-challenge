...
function createFeatures(earthquakeData, tectonicPlates) {
    ...
    var earthquakes = L.geoJSON(earthquakeData, {
        onEachFeature: (feature, layer) => layer.bindPopup(
            ...
            "<p>Maginitude:" + feature.properties.mag + "</p>"
        ),
   ...
   var tectonicPlates = L.geoJSON(tectonicPlates, {
        "type": "LineString",
        "stroke":true,
        "color": "orange",
        "weight": 2
...
function createMap(earthQuakes, tectonicPlates) {
    ...
    var sateliteMapLayer = L.tileLayer(
    ...
    var outdoorMapLayer = L.tileLayer(
    ...
    var earthQuakeMap = L.map(
        "map", {
            center:[27.4, -42.7],
            zoom: 3,
            layers: [lightMapLayer, tectonicPlates, earthQuakes,]
        }
    );

    var baseMaps = {
        "Light Map": lightMapLayer, 
        "Dark Map": darkMapLayer,
        "Outdoors": outdoorMapLayer,
        "Satellite": sateliteMapLayer
    }
    var overlayMarkers = {
